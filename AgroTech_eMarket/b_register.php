...
<html lang="en">
    ...
    <body>
        ...
        <form id="box" action="b_register_process.php" method="POST">

          <div style="font-size: 20px;margin: 10px;">Customer Sign Up</div>
              ...
              <input id="button1" type='button' value="Farmer Registration" onclick="f_registration();">
        ...
        function selectCity(){
            ...
            function f_registration(){
                location.assign('f_register.php');
            }
