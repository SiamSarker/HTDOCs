...
if($_SERVER['REQUEST_METHOD']=='POST'){
    ...
    )
    {
        ...
        try{
            ...
            $signupquery="SELECT * FROM buyer WHERE b_username = '".$username."'";
            ...
            if($returnobj->rowCount() == 1)
            {
                ...
                <script>location.assign("b_register.php");</script>
                <?php
            }
            else
            {
                ...
                $signupquery="INSERT INTO buyer VALUES('$username','$enc_password','$name','$address', $contact, '$district','$city')";
