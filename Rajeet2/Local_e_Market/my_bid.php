              ...
              <table id="p_table">
                <thead>
                  ...
                  try{
                    ...
                    $sqlquary="SELECT* FROM all_bid AS abid JOIN bid_room AS bid ON abid.auction_id = bid.auction_id JOIN product AS pro ON pro.p_id = bid.Productp_id WHERE abid.b_username = '$_SESSION[b_username]'";
                      ...
                      foreach ($table_data as $row) {
                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            $user = strtolower($_SESSION['b_username']);
                            $id=$row['auction_id'];
