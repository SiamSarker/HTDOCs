    ...
    if(isset($_SESSION['username']) && !empty($_SESSION['username'])){
      if(isset($_GET['bid_id']) && !empty($_GET['bid_id'])){
            ...
            try{
              ...
              $sqlquary="SELECT* FROM all_bid AS abid JOIN bid_room AS bid ON abid.auction_id = bid.auction_id JOIN product AS pro ON bid.p_id = pro.p_id WHERE bid_id = $bid_id";
