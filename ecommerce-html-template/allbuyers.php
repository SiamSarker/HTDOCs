            ...
            <body>
              ...
              <!-- <h1 class="header">
                                ...
                                if($returnobj->rowCount()==0){
                                    ...
                                    foreach($returntable as $row){
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                    <br>
                                                    <input type="button" id="button" value="BLOCK" onclick="block(<?php echo $row['b_username']?>);">
                                                    <br><br>
                                                    <input type="button" id="button" value="DELETE" onclick="delete_data(<?php echo $row['b_username']?>);">
                                                    <br><br>
                ...
                <script>
                    ...
                    function deleteb(username){

                        location.assign('admin_delete_buyer.php?username='+username);
                    }
