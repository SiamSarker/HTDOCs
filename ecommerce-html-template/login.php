...
<!-- <form id="box" action="f_register.php" method="POST">  
<div style="font-size: 20px;margin: 5px;">Don't have an account? Register as a farmer!</div>
    ...
    <div style="font-size: 20px;margin: 5px;">Don't have an account? Register as a customer!</div>     
